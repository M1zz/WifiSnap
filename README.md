...
> 앱 이름은 **마이파이**입니다. 저장소·타깃·폴더 이름(`WifiSnap`), 번들 ID(`com.leeo.wifisnap`),
> App Group(`group.com.leeo.wifisnap`), URL 스킴(`wifisnap://`)은 **기술 식별자라 그대로 둡니다** —
> 바꾸면 앱스토어 업데이트가 끊기고 기기에 저장된 데이터가 사라집니다.
